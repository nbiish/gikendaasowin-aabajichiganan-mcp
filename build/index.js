...
server.tool("chain_of_thought", "Generates explicit, sequential reasoning steps for complex problem-solving. This tool breaks down a problem into a detailed, linear sequence of logical deductions. Ideal for tasks requiring high explainability. Output MUST be analyzed using the 'think' tool.", {
...
server.tool("reflection", "Facilitates self-critique and iterative improvement of reasoning or plans. This tool evaluates logical consistency, completeness, and potential biases, then suggests specific refinements. Use its output within a subsequent 'think' step.", {
...
server.tool("plan_and_solve", "Develops a high-level, structured strategy for complex, multi-stage objectives. This tool outlines major phases required to achieve a goal, identifying which approaches might be needed at each stage. The generated plan MUST be reviewed within the 'think' tool.", {
...
server.tool("chain_of_draft", "Generates concise, iterative drafts of reasoning steps, prioritizing efficiency over exhaustive detail. This tool produces brief, essential intermediate thoughts, allowing for rapid exploration without the verbosity of full chain-of-thought. Output MUST be analyzed via the 'think' tool.", {
